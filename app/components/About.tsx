...
export default function About(){
	...
	return(
		<section id="about" className="py-14 px-16">
		
<div className="grid grid-cols-2 gap-16  mx-auto">
<div className="flex flex-col items-center justify-self-center gap-4">
	
	<div className="relative h-100 w-100 rounded-full overflow-hidden ring-4 ring-accent">
    ...
    <a href="#" className="text-3xl hover:text-accent transition-colors duration-200"><FaYoutube /></a>
		...
		<div className="flex flex-col items-center pl-1"> 
			...
			<p className="py-4 text-2xl text-foreground/70 leading-relaxed">Connor Alexander is a Nottingham-based videographer and content creator with a passion for visual storytelling. Graduating with a BA in Content Creation, Connor brings a creative eye and technical precision to every project — from brand campaigns to personal showreels. His work spans commercial, lifestyle, and event videography, crafting narratives that connect and resonate.</p>
		...
		<div ref={ref}className="flex gap-8 mt-8 text-center bg-foreground/5 rounded-2xl px-8 py-6">
			<div>
				...
				<p className="uppercase tracking-widest text-xs text-foreground/60 border-l border-foreground/20 pl-8">Projects Completed</p>
			</div>

			<div>
				<p className="text-accent text-4xl font-bold mb-2"> <CountUp target={1584} isInView={isInView} step={12} /> </p>
				<p className="uppercase tracking-widest text-xs text-foreground/60 border-l border-foreground/20 pl-8">Instagram Likes</p>
			</div>

			<div>
				<p className="text-accent text-4xl font-bold mb-2">BA</p>
				<p className="uppercase tracking-widest text-xs text-foreground/60 border-l border-foreground/20 pl-8">Content Creation</p>
			</div>
		</div>
